		...
		if(IsPedInAnyVehicle(MyPed, false))then
			...
			if HUD.CarGears then
				if VehStopped and (Speed == 0) then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "~r~P", 255, 255, 255, 200)
				elseif Gear < 1 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "R", 255, 255, 255, 200)						
				elseif Gear == 1 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "1", 255, 255, 255, 200)
				elseif Gear == 2 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "2", 255, 255, 255, 200)
				elseif Gear == 3 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "3", 255, 255, 255, 200)
				elseif Gear == 4 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "4", 255, 255, 255, 200)
				elseif Gear == 5 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "5", 255, 255, 255, 200)
				elseif Gear == 6 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "6", 255, 255, 255, 200)
				elseif Gear == 7 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "7", 255, 255, 255, 200)
				elseif Gear == 8 then
					drawTxt(UI.x + 0.683, UI.y + 1.432, 1.0,1.0,0.5, "8", 255, 255, 255, 200)
				end	
			end
			
			if HUD.SpeedIndicator then
				drawRct(UI.x + 0.683, 	UI.y + 1.470, 0.046,0.03,0,0,0,150)
				if HUD.Speed == 'kmh' then
					drawTxt(UI.x + 0.683, 	UI.y + 1.465, 1.0,1.0,0.5 , "~w~" .. math.ceil(Speed), 255, 255, 255, 255)
					drawTxt(UI.x + 0.660, 	UI.y + 1.470, 1.0,1.0,0.4, "~w~ KM/T", 255, 255, 255, 255)
					drawTxt(UI.x + 0.661, 	UI.y + 1.435, 1.0,1.0,0.4, "~w~ GEAR", 255, 255, 255, 255)
					drawTxt(UI.x + 0.661, 	UI.y + 1.405, 1.0,1.0,0.4, "~w~ BENZIN", 255, 255, 255, 255)
				elseif HUD.Speed == 'mph' then

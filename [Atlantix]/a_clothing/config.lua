...
menu_options = {
    ...
    {name = "Reset Karakter", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {name="Tøjbutik", id=73, x=1932.76989746094, y=3727.73510742188, z=32.8444557189941},
    {name="Tøjbutik", id=73, x=1693.26, y=4822.27, z=42.06},
    {name="Tøjbutik", id=73, x=125.83, y=-223.16, z=54.55},
    {name="Tøjbutik", id=73, x=-710.16, y=-153.26, z=37.41},
    {name="Tøjbutik", id=73, x=-821.69, y=-1073.90, z=11.32},
    {name="Tøjbutik", id=73, x=-1192.81, y=-768.24, z=17.31},
    {name="Tøjbutik", id=73, x=4.25, y=6512.88, z=31.87},
    {name="Tøjbutik", id=73, x=451.86569213867, y=-992.97058105469, z=30.689588546753},
    {name="Tøjbutik", id=73, x=424.18026733398, y=-799.80865478516, z=29.506244659424},
	{name="Black Devils tøj butik", id=73, x=984.2, y=-91.5, z=74.8911},
}
incircle = false
            ...
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                ...
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("Tryk ~INPUT_CONTEXT~ for at vælge tøj.")
                    end
                    incircle = true

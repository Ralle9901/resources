vRPbsT = {}
Tunnel.bindInterface("a_seatswitch",vRPbsT)
Proxy.addInterface("a_seatswitch",vRPbsT)
vRPbsS = Tunnel.getInterface("a_seatswitch","a_seatswitch")
...
RegisterNetEvent('a:seatSwitch')
AddEventHandler('a:seatSwitch', function(choice)

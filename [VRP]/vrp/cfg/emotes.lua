...
cfg.emotes = {
  ...
  ["Smoke Weed"] = {false, {task="WORLD_HUMAN_DRUG_DEALER"}, false},
  ["Tourist map"] = {false, {task="WORLD_HUMAN_TOURIST_MAP"}, false},
  ["Drill in earth"] = {false, {task="WORLD_HUMAN_CONST_DRILL"}, false},
  ["Give money"] = {false, {task="PROP_HUMAN_PARKING_METER"}, false},
  ["Carfix"] = {false, {task="WORLD_HUMAN_VEHICLE_MECHANIC"}, false},
  ...
  ["Washing"] = {false, {task="WORLD_HUMAN_BUM_WASH"}, false},
  ["Plant"] = {false, {task="WORLD_HUMAN_GARDENER_PLANT"}, false},
  ["Beggar"] = {false, {task="WORLD_HUMAN_BUM_FREEWAY"}, false},
  ["Check Patient"] = {false, {task="CODE_HUMAN_MEDIC_TEND_TO_DEAD"}, false},
  ["Traffic"] = {false, {task="WORLD_HUMAN_CAR_PARK_ATTENDANT"}, false},
  ["Washing Window"] = {false, {task="WORLD_HUMAN_MAID_CLEAN"}, false},
  ["Leaning Down"] = {false, {task="WORLD_HUMAN_BUM_SLUMPED"}, false},
  ["Motion"] = {false, {task="WORLD_HUMAN_JANITOR"}, false},
  ["Guard"] = {false, {task="WORLD_HUMAN_GUARD_STAND"}, false},
  ["Torch"] = {false, {task="WORLD_HUMAN_SECURITY_SHINE_TORCH"}, false},
  ["Lift"] = {false, {task="WORLD_HUMAN_MUSCLE_FREE_WEIGHTS"}, false},
  ...
  ["Blow"] = {false, {task="WORLD_HUMAN_GARDENER_LEAF_BLOWER"}, false},

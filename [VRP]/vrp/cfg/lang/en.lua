...
local lang = {
  ...
  police = {
    ...
    menu = {
	  ...
	  spikes = {
        title = "Spawn spikes",
        description = "Place spikes at your location."
      },
	  dragplayer = {
        title = "Drag player",
        description = "Drag nearest player."
      }
    },
    identity = {
  ...
  vehicle = {
	...
	opendoor0 = {
      ...
      description = "Open/close the left front door."
    },
	opendoor1 = {
      title = "Right front door",
      description = "Open/close the right front door."
    },
	opendoor2 = {
      title = "Left rear door",
      description = "Open/close the left rear door."
    },
	opendoor3 = {
      title = "Right front door",
      description = "Open/close the right rear door."
    },
	opendoor4 = {
      title = "Hood",
      description = "Open/close the hood."
    },
	opendoor5 = {
      title = "Trunk",
      description = "Open/close the trunk."
    },
	closealldoors = {

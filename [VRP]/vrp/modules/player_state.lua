  ...
  if first_spawn then -- first spawn
    ...
    SetTimeout(15000,function()
		-- vRPclient.notify(player,{lang.common.welcome({tmpdata.last_login})})
		 TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.common.welcome({tmpdata.last_login})}, type = "info", queue = "global", timeout = 10000, layout = "bottomRight",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
		end)

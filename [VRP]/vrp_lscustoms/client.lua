...
local lsc = {
	...
	,["primarymetallic"] = { 
		...
		name = "repair",
		buttons = { 
			{name = "Repair vehicle", description = "Full body repair and engine service.", costs = math.random(5000,25000), centre = 0, font = 0, scale = 0.4}
					...
					for i,pos in ipairs(lsc.locations) do
						...
						if GetDistanceBetweenCoords(outside.x,outside.y,outside.z,GetEntityCoords(ped)) <= f(5) then
							if pos.locked == false then
								lsc_drawTxt("Tryk ~b~ENTER~w~ for at gå til mekanikeren",4,1,0.5,0.8,1.0,255,255,255,255)
...
AddEventHandler('lscustoms:payGarageFalse', function()
	-- vRP.notify({"Du har ikke råd."})
	TriggerEvent("pNotify:SendNotification",{
	text = "Du har <b style='color:#ff0000'>ikke råd</b>",
	type = "error",
	timeout = (3000),
	layout = "centerLeft",
	queue = "global",
...
AddEventHandler('lscustoms:UpdateDone', function()
	...
	TriggerEvent("pNotify:SendNotification",{
	text = "Køretøj <b style='color:#0dad18'>gemt</b>",
	type = "success",
	timeout = (3000),
	layout = "centerLeft",
	queue = "global",
...
AddEventHandler('lscustoms:StoreVehicleFalse', function()
	-- vRP.notify({"Du ejer ikke dette køretøj."})
		TriggerEvent("pNotify:SendNotification",{
	text = "Du ejer <b style='color:#ff0000'>ikke dette køretøj</b>",
	type = "error",
	timeout = (3000),
	layout = "centerLeft",
	queue = "global",
